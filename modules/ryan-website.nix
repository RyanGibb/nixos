        ...
        "${cfg.domain}" = {
          ...
          locations."/var/" = {
            ...
            extraConfig = ''
              ...
              add_header Content-Security-Policy "default-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; base-uri 'self'; frame-src 'self'; frame-ancestors 'self'; form-action 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com blob:; worker-src blob:; img-src 'self' https://unpkg.com data:;" always;
            '';
          };
          locations."~ \\.bib$" = {
            extraConfig = ''
